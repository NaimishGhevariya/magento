...
$table = $installer->getConnection()
    ...
    ->addIndex(
        $installer->getIdxName('vendor/eav_productAttribute', array('used_in_product_listing')),
        array('used_in_product_listing')
    )
    ->addForeignKey(
        $installer->getFkName('vendor/eav_productAttribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id',
