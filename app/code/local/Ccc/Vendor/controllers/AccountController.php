...
class Ccc_Vendor_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        ...
        $dashboard = $this->getLayout()->createBlock('vendor/account_dashboard');
        $this->getLayout()->getBlock('content')->append($dashboard);
    ...
    public function createAction()
    {
        ...
        $this->loadLayout();
        // $this->_addContent($this->getLayout()->createBlock("vendor/form_register"));
        $this->_initLayoutMessages('vendor/session');
        $this->renderLayout();
    }
    ...
    public function createPostAction()
    {
        ...
        /** @var $session Ccc_Vendor_Model_Session */
        $session = $this->_getSession();
        if ($session->isLoggedIn()) {
            $this->_redirect('*/*/');
            return;
    ...
    // {
    //     $errors = array();
    //     /* @var $address Ccc_Vendor_Model_Address */
    //     $address = $this->_getModel('vendor/address');
    //     /* @var $addressForm Ccc_Vendor_Model_Form */
    ...
    protected function _welcomeVendor(Ccc_Vendor_Model_Vendor $vendor, $isJustConfirmed = false)
    {
        ...
        //             $userPrompt = $this->__(
        //                 'If you are a registered VAT vendor, please click <a href="%s">here</a> to enter you shipping address for proper VAT calculation',
        //                 $this->_getUrl('vendor/address/edit')
        //             );
        //             break;
        //         default:
        //             $userPrompt = $this->__(
        //                 'If you are a registered VAT vendor, please click <a href="%s">here</a> to enter you billing address for proper VAT calculation',
        //                 $this->_getUrl('vendor/address/edit')
        //             );
        //     }
    ...
    public function forgotPasswordPostAction()
    {
        ...
        if ($email) {
            /**
             * @var $flowPassword Ccc_Vendor_Model_Flowpassword
             */
     ...
     *
     * @param Ccc_Vendor_Model_Session $session
