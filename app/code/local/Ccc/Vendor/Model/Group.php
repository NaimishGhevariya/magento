 ...
 * Vendor group model
 *
 * @method Ccc_Vendor_Model_Resource_Group _getResource()
 * @method Ccc_Vendor_Model_Resource_Group getResource()
 * @method string getVendorGroupCode()
 * @method Ccc_Vendor_Model_Group setVendorGroupCode(string $value)
 * @method Ccc_Vendor_Model_Group setTaxClassId(int $value)
 *
 * @category    Mage
 * @package     Ccc_Vendor
