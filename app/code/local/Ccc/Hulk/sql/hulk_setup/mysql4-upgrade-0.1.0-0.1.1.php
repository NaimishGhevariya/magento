...
$table = $installer->getConnection()
    ->newTable($installer->getTable('hulk/eav_attribute'))
    ...
    ->addIndex(
        $installer->getIdxName('hulk/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by')
    )
    ->addIndex(
        $installer->getIdxName('hulk/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing')
    )
    ->addForeignKey(
        $installer->getFkName('hulk/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id',
    ...
    ->setComment('hulk EAV Attribute Table');

$query = "ALTER TABLE `hulk_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Ccc_Hulk_Model_Resource_Hulk::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Ccc_Hulk_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Ccc_Hulk_Model_Resource_Hulk::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Ccc_Hulk_Model_Resource_Hulk::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
