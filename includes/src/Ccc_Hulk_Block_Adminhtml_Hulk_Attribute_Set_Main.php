...
class Ccc_Hulk_Block_Adminhtml_Hulk_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{

    protected function _construct()
    {
        $this->setTemplate('hulk/attribute/set/main.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            'group_tree',
            $this->getLayout()->createBlock('hulk/adminhtml_hulk_attribute_set_main_tree_group')
        );

        $this->setChild(
            'edit_set_form',
            $this->getLayout()->createBlock('hulk/adminhtml_hulk_attribute_set_main_formset')
        );

        $this->setChild(
            'delete_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Delete Selected Group'),
        ...
        $this->setChild(
            'add_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Add New'),
        ...
        $this->setChild(
            'back_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Back'),
        ...
        $this->setChild(
            'reset_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Reset'),
        ...
        $this->setChild(
            'save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Save Attribute Set'),
                'onclick'   => 'editSet.save();',
                'class'     => 'save'
            ))
        );

        $deleteConfirmMessage = $this->jsQuoteEscape(Mage::helper('hulk')
        ...
        $this->setChild(
            'delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('Delete Attribute Set'),
        ...
        $this->setChild(
            'rename_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('hulk')->__('New Set Name'),
    ...
    {
        return Mage::helper('hulk')->__("Edit Attribute Set '%s'", $this->_getAttributeSet()->getAttributeSetName());
    }


    public function getMoveUrl()
    {
        return $this->getUrl('*/hulk_set/save', array('id' => $this->_getSetId()));
    }

    public function getGroupUrl()
    {
        return $this->getUrl('*/hulk_group/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getGroupTreeJson()
    {
        ...
        foreach ($groups as $node) {
            ...
            $nodeChildren = Mage::getResourceModel('hulk/hulk_attribute_collection')
    ...
    public function getAttributeTreeJson()
    {
        ...
        $attributes = Mage::getResourceModel('hulk/hulk_attribute_collection')
        ...
        if (count($items) == 0) {
            $items[] = array(
                'text'      => Mage::helper('hulk')->__('Empty'),
                'id'        => 'empty',
                'cls'       => 'folder',
                'allowDrop' => false,
                'allowDrag' => false,
